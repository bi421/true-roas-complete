...
from ..core.subscriptions import SubscriptionService, PlanType, Subscription
...
async def _handle_payment_failed(db: Session, invoice: Dict[str, Any]):
    ...
    if sub:
        await send_payment_failure(
            sub.tenant_id, retry_url="https://trueroas.com/billing"
        )
