...
def migrate_learning_table() -> None:
    """Additive migration: Creates learning_policies table in PostgreSQL."""
    db = SessionLocal()
    try:
        ...
        db.commit()
        logger.info("Migration successful: 'learning_policies' table is ready.")
    finally:
        db.close()


if __name__ == "__main__":
    migrate_learning_table()
