...
class Tenant(Base):
    ...
    def is_active(self) -> bool:
        ...
        return self.status == TenantStatus.ACTIVE and (
...
class SubscriptionService:
    ...
    def activate_subscription(
        ...
        if not sub:
            sub = Tenant(slug=tenant_id, name=tenant_id, sqlite_path=f"./data/tenants/{tenant_id}.db", tenant_secret_salt=secrets.token_urlsafe(32))
            db.add(sub)
