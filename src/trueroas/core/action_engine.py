...
async def execute_circuit_breaker(tenant_id: str, action_required: str, campaign_id: str, access_token: str = "redacted") -> Dict[str, Any]:
    """
...
async def generate_capi_truth_file(tenant_id: str, db_path: str) -> str:
    ...
    with duckdb.connect(db_path, read_only=True) as con:
        ...
        writer.writerow(["event_name", "event_time", "event_id", "action_source", "value", "currency"])
        for row in results:
