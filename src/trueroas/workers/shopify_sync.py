    ...
    with duckdb.connect(db_path) as con:
        ...
        for date, spend, meta_roas in rows:
            if not token:  # Demo.
                ...
                count, mean, var, conf = 0, 0.0, 0.0, 0.0
                ...
                for _ in range(num_orders):
                    ...
                    count, mean, var, conf = DecisionEngine.update_historical_stats(count, mean, var, order_value)
...
if __name__ == "__main__":
    ...
    print(f"--- Shopify Sync Audit (Mode: {'LIVE' if settings.SHOPIFY_TOKEN else 'DEMO'}) ---")
    ...
    try:
        ...
        print(f"CRITICAL Error during Shopify Sync: {e}")
